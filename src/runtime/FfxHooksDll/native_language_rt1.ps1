...
$sources=@('tests\NativeLanguageWindowsRt1.cpp','hooks\NativeLanguageHook.cpp','hooks\F8RuntimeCore.cpp') | ForEach-Object {'"'+(Join-Path $PSScriptRoot $_)+'"'}
$exe=Join-Path $obj 'NativeLanguageWindowsRt1.exe'
Push-Location $obj
try {
