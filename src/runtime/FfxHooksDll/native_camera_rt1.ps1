...
$sources=@('tests\NativeCameraRt1.cpp','hooks\NativePortsHook.cpp','hooks\NativeGamepadHook.cpp','shared\Config.cpp','hooks\F8FlagCatalog.cpp','hooks\F8RuntimeCore.cpp') | ForEach-Object {'"'+(Join-Path $PSScriptRoot $_)+'"'}
$exe=Join-Path $obj 'NativeCameraRt1.exe'
Push-Location $obj
try {
