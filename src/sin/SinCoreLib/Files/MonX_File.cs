...
namespace SinCoreLib.Files
{
    public partial class MonX_File
    {
        ...
        public static MonX_File Read(byte[] byteFile)
        {
            ...
            using (BinaryReader br = new BinaryReader(stream))
            {
                ...
                foreach (Entry entry in file.Entries)
                {
                    ...
                    entry.NameScriptBytes = bytesName.ToArray();
                    ...
                    entry.SensorScriptBytes = bytesSensor.ToArray();
                    ...
                    entry.UnkScriptBytes = bytesUnk.ToArray();
                    ...
                    entry.ScanScriptBytes = bytesScan.ToArray();
                    ...
                    entry.Unk2ScriptBytes = bytesUnk2.ToArray();
        ...
        public class Header
        {
            ...
            [Data(Count=7)] public byte[] UnknownBytes { get; set; } = new byte[7]; // Probably 4 shorts including the version
        ...
        public class Entry
        {
            public FfxEncoding.TextScript NameScript { get; set; } = new();
            public FfxEncoding.TextScript SensorScript { get; set; } = new();
            public FfxEncoding.TextScript UnkScript { get; set; } = new();
            public FfxEncoding.TextScript ScanScript { get; set; } = new();
            public FfxEncoding.TextScript Unk2Script { get; set; } = new();
            public byte[] NameScriptBytes { get; set; } = System.Array.Empty<byte>();
            public byte[] SensorScriptBytes { get; set; } = System.Array.Empty<byte>();
            public byte[] UnkScriptBytes { get; set; } = System.Array.Empty<byte>();
            public byte[] ScanScriptBytes { get; set; } = System.Array.Empty<byte>();
            public byte[] Unk2ScriptBytes { get; set; } = System.Array.Empty<byte>();
            ...
            [Data(Count=16)] public short[] Abilities { get; set; } = new short[16];
            ...
            [Data(Count=4)] public byte[] Padding { get; set; } = new byte[4];
        }
    }
}
